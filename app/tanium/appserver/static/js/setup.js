$(document).ready(function() {
    ...
    var allSettingsEboxId = "#\\/tanium_input_setup\\/tanium_settings\\/tanium_settings\\/all_settings_id";
    ...
    function updateCustomizedSettings(settings) {
        ...
        if (settings.customized_settings["taniumhost"]){
            $("#taniumhost_id").val(settings["customized_settings"]["taniumhost"]["content"]);
        }
    };
